...
// main compute temp routine but with them placed in an order so that all 
// processes first send and then they receive from adjacent processes. This is 
// unsafe in general because deadlocks could occur if the MPI Buffer for the 
// particular MPI implementation is too small.
using namespace std;
#include <stdlib.h>
#include <iostream>
#include <iomanip>
